...
const TempleHero = () => {
  return (
    <section
      ...
      style={{ background: "linear-gradient(160deg,#fff7ed 0%,#ffffff 55%,#fff7ed 100%)" }}
    >
      ...
      <div className="absolute -top-6 right-4 md:right-16 pointer-events-none select-none"
        style={{ opacity: 0.045 }}>
        <span className="text-[160px] md:text-[220px] font-serif text-orange-600 leading-none">ॐ</span>
      </div>

      {/* ── Soft glow blobs ── */}
      <div className="absolute top-1/2 -left-20 w-72 h-72 rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle,rgba(234,88,12,0.1),transparent 70%)", transform: "translateY(-50%)" }} />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-7 text-center lg:text-left">
            ...
            {/* Eyebrow tag */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold text-orange-700 shadow-sm"
              style={{ background: "rgba(255,247,237,0.95)", border: "1px solid rgba(234,88,12,0.22)" }}>
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              ...
              <span className="font-bold text-gray-800">शुद्ध, ताज़ा और आशीर्वाद से भरपूर प्रसाद</span>{" "}
              सीधे आपके घर तक।
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
              ...
              <a href="https://wa.me/918351927365" target="_blank" rel="noreferrer"
                className="flex items-center justify-center gap-2.5 px-8 py-4 rounded-2xl text-white font-black text-base transition-all duration-300 hover:-translate-y-1 hover:scale-[1.03] active:scale-95"
                style={{
          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            <div
              ...
              style={{ background: "radial-gradient(ellipse at center,rgba(234,88,12,0.13),transparent 70%)", filter: "blur(12px)" }}
            />
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden"
                style={{
                  ...
                  boxShadow: "0 24px 60px rgba(234,88,12,0.18), 0 4px 20px rgba(0,0,0,0.08)",
                }}>
                <img
                  src={mahakal1}
